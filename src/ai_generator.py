...
_PHOTO_ANALYSIS_PROMPT = (
    "This photograph was taken by an Area Project Manager during a facility site assessment "
    "and almost certainly depicts coating failure, surface damage, or substrate deterioration "
    "that requires remediation. The APM took this photo specifically because it shows a "
    "problem area. Do not state that you are unable to analyze coating conditions — "
    "describe what you observe and make reasonable professional inferences from the visible "
    "evidence. Facility surfaces include floors, walls, ceilings, roofs, structural steel, "
    "pipes, and equipment — analyze whatever surface is shown.\n\n"
    "Provide a structured failure analysis:\n\n"
    "1. **Surface Location:** Identify the surface type shown (floor, wall, ceiling/roof, "
    "structural steel, pipe, equipment, or other) and the substrate material (concrete slab, "
    "concrete block, carbon steel, galvanized steel, masonry, wood, or other).\n"
    "2. **Failure Type(s):** Visible coating or surface failure modes — including but not "
    "limited to: delamination, blistering, rust-through, chalking, cracking, spalling, "
    "joint failure, erosion, abrasion wear, biological growth (mold/mildew/algae), "
    "efflorescence, or impact damage.\n"
    "3. **Estimated Severity:** Light, Moderate, or Severe — briefly justify based on "
    "visible affected area and depth of damage.\n"
    "4. **Surface Contamination Indicators:** Visible contamination (oil, salts, moisture "
    "intrusion, efflorescence, rust staining, standing water, chemical exposure).\n"
    "5. **Recommended Action:** Corrective action implied by the observed condition, "
    "referencing applicable surface preparation standard (e.g., SSPC-SP 13 for concrete, "
    "SSPC-SP 6 for steel) and the type of coating system appropriate for the substrate "
    "and use environment.\n\n"
    "Be specific and factual. If any portion of the image is partially obscured, describe "
    "what is visible and note any limitations. Do not decline to analyze."
)
